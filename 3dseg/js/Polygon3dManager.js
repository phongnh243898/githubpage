...
export class Polygon3dManager {
    ...
    setupEvents() {
        window.addEventListener('keydown', (e) => {
            ...
            if (e.key === 'Escape') this.exitCurrentOperation(true); // nếu đang vẽ dang dở, lưu và đóng
            if (e.key === 'Delete') this.deleteActive();
            if (e.key === 'PageUp') this.cycleColor();
